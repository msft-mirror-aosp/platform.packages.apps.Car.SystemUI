...
interface HvacPropertySetter {
    ...
    /**
     * Sets a new {@link HvacController.HvacProperty} of integer type for a given {@link
     * HvacController.AreaId}.
     */
    void setHvacProperty(@HvacController.HvacProperty Integer propertyId, int areaId, int val);

    /**
     * Sets a new {@link HvacController.HvacProperty} of float type for a given {@link
     * HvacController.AreaId}.
     */
    void setHvacProperty(@HvacController.HvacProperty Integer propertyId, int areaId, float val);

    /**
     * Sets a new {@link HvacController.HvacProperty} of boolean type for a given {@link
     * HvacController.AreaId}.
     */
