...
public class ButtonSelectionStateController {
    ...
    private final HashMap<CarSystemBarButton, View.OnAttachStateChangeListener>
            mAttachStateListenerMap = new HashMap<>();
    ...
    protected void removeAll() {
        ...
        mRegisteredViews.forEach(button -> {
            if (mAttachStateListenerMap.containsKey(button)) {
                button.removeOnAttachStateChangeListener(mAttachStateListenerMap.get(button));
            }
        });

        mRegisteredViews.clear();
        mAttachStateListenerMap.clear();
    }
    ...
    private void addButtonWithSelectionState(CarSystemBarButton carSystemBarButton) {
        ...
        carSystemBarButton.addOnAttachStateChangeListener(new View.OnAttachStateChangeListener() {
            @Override
            public void onViewAttachedToWindow(View v) {
                if (v instanceof CarSystemBarButton button) {
                    selectForInitialPanelTaskState(button);
                }
            }
        ...
        if (isScalableUIEnabled() && mTaskPanelInfoRepository != null) {
            if (carSystemBarButton.isAttachedToWindow()) {
                ...
                View.OnAttachStateChangeListener listener = new View.OnAttachStateChangeListener() {
                    ...
                    public void onViewAttachedToWindow(View v) {
                        ...
                        mAttachStateListenerMap.remove(carSystemBarButton);
                        if (v instanceof CarSystemBarButton button) {
                            selectForInitialPanelTaskState(button);
                        }
                    }
                ...
                mAttachStateListenerMap.put(carSystemBarButton, listener);
                carSystemBarButton.addOnAttachStateChangeListener(listener);
            }
        }
    }
