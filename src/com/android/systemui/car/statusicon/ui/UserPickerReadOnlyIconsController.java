...
/**
 *  A Controller for a group of read-only status icons in the bottom bar of user picker.
 */
public class UserPickerReadOnlyIconsController extends StatusIconGroupContainerController {
    ...
    protected int getStatusIconControllersStringArray() {
        return R.array.config_userpickerReadOnlyIconControllers;
    }
