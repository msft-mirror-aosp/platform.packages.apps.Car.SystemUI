...
public class HvacControllerTest extends SysuiTestCase {
    ...
    public void registerHvacView_viewRegisteredInMapBySubscribingProperty() {
        ...
        mHvacController.registerHvacView(mTestHvacView1);

        assertTrue(mHvacController.getHvacPropertyViewMap().get(HVAC_TEMPERATURE_SET).get(
    ...
    public void unregisterHvacView_viewNotRegisteredInMap() {
        ...
        mHvacController.unregisterView(mTestHvacView1);

        assertNull(mHvacController.getHvacPropertyViewMap().get(HVAC_TEMPERATURE_SET));
    }
    ...
    public void hvacPropertyChanged_hvacTurnedOn_allViewsHandleChange() {
        ...
        verify(mTestHvacView1).onHvacOnOffChanged(true);
        verify(mTestHvacView2).onHvacOnOffChanged(true);
        verify(mTestHvacView3).onHvacOnOffChanged(true);
    }
    ...
    public void hvacPropertyChanged_hvacTurnedOff_allViewsHandleChange() {
        ...
        verify(mTestHvacView1).onHvacOnOffChanged(false);
        verify(mTestHvacView2).onHvacOnOffChanged(false);
        verify(mTestHvacView3).onHvacOnOffChanged(false);
    }
    ...
    private void registerAllTestHvacViews() {
        ...
        mHvacController.registerHvacView(mTestHvacView1);
        mHvacController.registerHvacView(mTestHvacView2);
        mHvacController.registerHvacView(mTestHvacView3);
    }

    private void unregisterAllTestHvacViews() {
        mHvacController.unregisterView(mTestHvacView1);
        mHvacController.unregisterView(mTestHvacView2);
        mHvacController.unregisterView(mTestHvacView3);
    }

    private class TestHvacView extends View implements HvacView {
